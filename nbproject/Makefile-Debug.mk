...
${OBJECTDIR}/src/ClientFactory.o: src/ClientFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ClientFactory.o src/ClientFactory.cpp

${OBJECTDIR}/src/ServerImp.o: src/ServerImp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ServerImp.o src/ServerImp.cpp

${OBJECTDIR}/src/ClientFactoryImp.o: src/ClientFactoryImp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ClientFactoryImp.o src/ClientFactoryImp.cpp
